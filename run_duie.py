...
def do_train():
    ...
    for epoch in range(args.num_train_epochs):
        ...
        for step, batch in enumerate(train_data_loader):
            ...
            relation_input_ids, relation_token_type_ids, relation_attention_mask, relation_labels = from_dict2_relation(batch_subjects=None,batch_objects=None, batch_origin_info= origin_info ,tokenizer=tokenizer,max_length=args.max_seq_length)
